...
export default function TermsPage() {
  return (
    <AboutShell active="terms" title="服务条款" updated="2026-05-08">
      ...
      <H2>5. 内容下架</H2>
      <P>如您是某条内容的权利人,认为本站展示侵犯了您的权利,可通过 <a href="/about/dmca" style={{ color: '#a5b4fc' }}>版权投诉</a> 流程通知我们,我们将在合理时间内处理。</P>

      <H2>6. 条款变更</H2>
      <P>本站保留随时修订本服务条款的权利。修订后的条款将于本页发布即生效,本页底部的"最近更新"日期会同步刷新。</P>

      <P style={{ color: '#64748b', fontSize: 13, marginTop: 32 }}>※ 本文为占位文本,正式上线前请由法律顾问审阅并替换。</P>
    </AboutShell>
  );
}

...
export async function registerDay5(app: FastifyInstance) {
  // Published article stats
  app.get('/admin/day5/stats', async () => {
  ...
  app.get('/admin/day5/items', async (req) => {
  ...
  app.post('/admin/day5/force-publish/:id', async (req, reply) => {
  ...
  app.post('/admin/day5/publish-all', async () => {
  ...
  app.post('/admin/day5/score-now', async () => {

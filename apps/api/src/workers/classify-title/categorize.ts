...
const CATEGORY_KEYWORDS: Record<Category, RegExp[]> = {
  ...
  '黑丝': [/黑丝|黑色丝袜/],
  // 91porny 上特定 fetish 子类,优先级高于 调教 之类宽规则
  '肛交': [/肛交|菊花|后庭|肛门|爆菊|肛塞/, /肛交/],
  '孕妇': [/孕妇|怀孕|大肚|妊娠/, /孕妇|怀孕/],
  ...
  // 关系/身份 — 91porny 的高频独立维度
  'NTR': [
    /NTR|出轨|绿帽|绿奴|换妻|淫妻|偷情|偷人|戴绿|寝取|分享女友|分享妻|借妻/i,
    /出轨|绿帽/,
  ],
  '网红': [
    /网红|主播|明星|偶像|抖音|快手|小红书|推特|TikTok|coser|coser网红/i,
    /网红|主播/,
  ],
